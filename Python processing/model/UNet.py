...
def UNet(pretrained_weights=None,input_size=(256,256,1)):
    ...
    Parameters
    ----------
    pretrained_weights : TYPE, optional
        DESCRIPTION. The default is None.
    input_size : TYPE, optional
        DESCRIPTION. The default is (256,256,1).
    ...
    #And the 
    model.compile(optimizer = Adam(lr = 1e-1), loss = customized_loss,metrics=['accuracy',dice_coef],sample_weight_mode='temporal')
